...
export const t: Record<Locale, Translations> = {
  de: {
    ...
    weddingPhotos: {
      ...
      uploadButton: "Foto / Video hochladen",
      uploading: "Hochladen...",
      success: "Erfolgreich hochgeladen!",
      error: "Fehler beim Hochladen. Bitte versuche es erneut.",
      gallery: "Galerie",
      noPhotos: "Noch keine Fotos — seid die Ersten!",
      uploadHint: "Fotos (max. 10 MB) und Videos (max. 50 MB, MP4/MOV/WebM)",
    },
    admin: {
      title: "Admin - Fotos",
  ...
  en: {
    ...
    weddingPhotos: {
      ...
      uploadHint: "Photos (max 10 MB) and videos (max 50 MB, MP4/MOV/WebM)",
    },
    admin: {
      title: "Admin - Photos",
      download: "Download",
